...
💎-report  『 للابلاغ عن شخص هام للادمن ان ينشؤو رووم ياسم report  』
...
-support|   الدعم الفني و المساعدة | https://discord.gg/EvwSx6p
...
لوق خروج اللاعب و دخوله 
ومسح وتعديل الرسالة 
كل ما عليك تسوي روم باسم 
bot-hell
...
if (message.content.startsWith(prefix + 'points')) {
    ...
    .setColor('#000000')
    .setDescription(`speed points: \`${userData.points}\``)
...
client.on('message', message => {
  ...
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/EvwSx6p**")
